...
#define DEBUG_HID_DESC_OFFSET      (9+KBD_HID_DESC_SIZE+MOUSE_HID_DESC_SIZE+9)
#define DEBUG_HID_DESC_SIZE        (9+9+7)

#ifdef USB_EXTRA_ENABLE
#  define EXTRA_HID_DESC_OFFSET    (9+KBD_HID_DESC_SIZE+MOUSE_HID_DESC_SIZE+DEBUG_HID_DESC_SIZE+9)
...
#ifdef USB_NKRO_ENABLE
#  define KBD2_HID_DESC_OFFSET     (9+KBD_HID_DESC_SIZE+MOUSE_HID_DESC_SIZE+DEBUG_HID_DESC_SIZE+EXTRA_HID_DESC_SIZE+9)
#  define KBD2_HID_DESC_SIZE       (9+9+7)
#else
#  define KBD2_HID_DESC_SIZE       0
#endif

#define CONFIG1_DESC_SIZE          (9+KBD_HID_DESC_SIZE+MOUSE_HID_DESC_SIZE+DEBUG_HID_DESC_SIZE+EXTRA_HID_DESC_SIZE+KBD2_HID_DESC_SIZE)
